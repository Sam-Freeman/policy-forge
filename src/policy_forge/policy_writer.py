...
Here is the structured context provided by the platform administrator:

\"\"\"{intent}\"\"\"

Based on this, write a comprehensive moderation policy that provides operational clarity and supports consistent enforcement. 
This policy will be used by trained moderators and trust & safety analysts for enforcement decisions.
...
Here is structured background context provided by the platform administrator:
...
""",
    ...
    return (
        ...
        machine_policy.choices[0].message.parsed,
    )
